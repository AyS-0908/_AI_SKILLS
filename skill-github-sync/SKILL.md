...
description: >
  ...
  to push files to GitHub, sync a local repo with GitHub, pull latest changes,
  publish local skill changes, inspect stale/untracked files before a push, or
...
5. IF committing:
   ...
   ```
6. Report branch, commit, pushed state, and remaining `review_items`.
